...
{
	if ((self=[super initWithFrame:CGRectMake(rect.origin.x,rect.origin.y,100,27)]))
	{
...
-(void)awakeFromNib
{
    ...
    [self setMinimumTrackImage:[UIImage imageNamed:@"switchSolid"] forState:UIControlStateNormal];
    [self setMaximumTrackImage:[UIImage imageNamed:@"switchLiquid"] forState:UIControlStateNormal];
...
//	[self setMaximumTrackImage:[UIImage imageNamed:@"switchOffPlain.png"] forState:UIControlStateNormal];
	...
	NSString *leftLabelText = NSLocalizedString(@"Solid","Custom UISwitch ON label. If localized to empty string then I/O will be used");
	...
	self.leftLabel.frame = CGRectMake(0, 0, 55, 23);
	...
	NSString *rightLabelText = NSLocalizedString(@"Liquid","Custom UISwitch OFF label. If localized to empty string then I/O will be used");
	...
	self.rightLabel.frame = CGRectMake(95, 0, 70, 23);
...
-(void)layoutSubviews
{
	...
	self.rightLabel.frame = CGRectMake(xPos - 2.0, 0, labelWidth, 23);
